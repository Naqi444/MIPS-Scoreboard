...
class Implementable():  
    def __init__(self, instruction, cycle):
        self.current_stage = stage.InstFetchStage(instruction)
    ...
    def resume_implementation(self):
        ...
        self.__change_cycles(previous_stage, self.current_stage)
        self.current_stage.run(self._instruction)
        return True


    def __change_cycles(self, previous_stage, current_stage):
